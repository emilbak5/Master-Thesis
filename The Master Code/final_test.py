...
def train(train_folder):
    ...
    logger = TensorBoardLogger('lightning_logs', name=MODEL_NAME + '_final_test', default_hp_metric=True, log_graph=False)
    ...
    data_module = StickerData(train_folder=train_folder, valid_folder='data_stickers/valid', test_folder='data_stickers/test', batch_size=2, num_workers=NUM_WORKERS)
...
if __name__ == '__main__':
    train('final_test/images100')
    train('final_test/images200')
    train('final_test/images300')
    train('final_test/images400')
    train('final_test/images500')
